...
TARGET_BOARD_PLATFORM := ac8227l               # From ro.mediatek.platform, but lowercase value
...
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset 0x04000000  --tags_offset 0x06900000
...
ifeq ($(TARGET_IS_32_BIT),true)
TARGET_ARCH := arm32
TARGET_ARCH_VARIANT := armv7-l
TARGET_CPU_ABI := armv7-v7l
TARGET_CPU_ABI2 :=
